...
rag_data = [{
        ...
        "context": "[['Security Monitoring Managed 서비스가 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring Managed 서비스는 네이버 서비스를 외부의 공격으로부터 안전하게 보호하고 있   는 보안전문 인력이 네이버 클라우드 플랫폼 고객의 서비스를 24시간 365일 보호하는 보안관제 서비스예요.\nSecurity Monitoring Basic 서비스에서 보다 강화  된 모니터링을 원하는 고객에게 유료로 제공되는 서비스로 탐지/차단 서비스 및 분석 서비스를 추가로 제공해요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '사용 가이드 자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://guide.ncloud-docs.com/docs/ko/security-security-8-2'}}}}}]]}]   ['Security Monitoring Managed 서비스에서 주간/월간 보고서를 제공하나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring Managed는 보다 강화된 모니터링을 원하는 고객에게 유료로 제공되는 서비스로   탐지/차단 서비스별 주간/월간 보고서를 제공하고 있어요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'Security Monitoring 소개 바로가기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/product/security/securityMonitoring'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '주간/월간 보고서 확인 방법 바로가기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://guide.ncloud-docs.com/docs/ko/security-security-8-2'}}}}}]]}]   ['WAF를 통해 차단된 것 같은데 예외 처리하려면 어떻게 해야하나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring에서 WAF를 통해 차단되었을 때 예외 처리하려면,  아래 두 항목을 포함하여 [고  객지원 > 문의하기]로 접수해 주세요.\n\n1. 예외 처리가 필요한 탐지 이벤트\n2. 예외 처리가 필요한 Request URL\n3. 예외 처리가 필요한 Source IP\n\n자세  한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2098'}}}}}]]}]   ['모의 침투 테스트란 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': '모의 침투 테스트란, 네이버 클라우드 플랫폼 상에 구성한 고객의 서비스 및 리소스에 대한 보안 수   준을 평가하기 위해 실제 공격과 유사한 행위를 수행하는 것을 의미해요.\n\n다만, 고객은 네이버 클라우드 플랫폼의 인프라 또는 네이버 클라우드 플랫폼 서   비스 자체에 대한 보안 평가를 수행할 수 없어요.\n\n모의 침투 테스트와 관련하여 상세한 정책과 사전 신청을 원하시는 경우, 아래 링크의 모의 침투 테스트   지원 정책 및 신청서를 참고해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '모의 침투 테스트 지원    정책 및 신청서', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/library'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2101'}}}}}]]}]   ['모의 침투 테스트를 하기 위한 네이버 클라우드 플랫폼의 지원 정책은 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': '네이버 클라우드 플랫폼은 고객의 보안인증 및 감사를 위한 혹은 자체 계획에 따른 모의 침투 테스트   진행을 지원하고 있어요.\n\n다만, 테스트 전 반드시 당사에 사전 신청을 해 주셔야 해요. 상세한 내용 및 사전 신청서의 양식은 아래 버튼을 눌러 확인해 주  세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '모의 침투 테스트 지원 정책 및 신청서 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/library'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2102'}}}}}]]}]   ['IPS V2 보안 이벤트 발생 시 어떻게 인지할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': 'Managed 서비스 이용 시 Security Monitoring IPS 이벤트가 발생하는 경우 Notification Setting에    설정된 정보로 이벤트 정보를 안내하고 있어요.\n상세 정보는 Console에서 확인하실 수 있어요.\n\nClassic 플랫폼 이용 시 [네이버 클라우드 플랫폼 > Console > Security Monitoring > Notification Setting > IPS(V1)]에서 안내받고자 하는 담당자를 설정할 수 있어요.\n\nVPC 플랫폼 이용 시 [네이버 클라우드 플랫  폼 > Console > Security Monitoring > Notification Setting > IPS(V2)]에서 안내받고자 하는 담당자를 설정할 수 있어요.\n\n자세한 내용은 아래 버튼을 눌   러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2117'}}}}}]]}]   ['Anti-DDoS 보안 이벤트 발생 시 어떻게 인지할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring Anti-DDoS 이벤트 발생 시 Managed 고객에게는 Notification Setting에 설정된   정보로 이벤트 정보를 안내하고 있어요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2123'}}}}}]]}]   ['WAF 보안 이벤트 발생 시 어떻게 인지할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring WAF 이벤트 발생 시 Managed 고객에게는 Notification Setting에 설정된 정보로   이벤트 정보를 안내하고 있어요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2122'}}}}}]]}]   ['IDS 보안 이벤트 발생 시 어떻게 인지할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring IDS 이벤트 발생 시 Managed 고객에게는 Notification Setting에 설정된 정보로   이벤트 정보를 간략하게 안내하고 있어요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2121'}}}}}]]}]   ['기본으로 제공되는 무료 보안 서비스는 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': 'Classic 플랫폼에서는 IDS, Anti-Virus(Window에 한해) 서비스를 무료로 제공하며,\nVPC 플랫폼에서   는 IDS 서비스를 무료로 제공해요. (Anti-Virus는 무료로 제공하지 않아요.)\n\n무료 보안 서비스에 대한 더 자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2120'}}}}}]]}]   ['IPS V2 서비스를 사용 시 주의사항은 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': 'IPS(V2) 서비스 사용 시 주의사항에 대해 알려 드릴게요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2116?searchKeyword=IPS%28V2%29%20%EC%84%9C%EB%B9%84%EC%8A%A4%EB%A5%BC%20%EC%82%AC%EC%9A%A9%20%EC%8B%9C%20%EC%A3%BC%EC%9D%98%20%EC%82%AC%ED%95%AD%EC%9D%80%20%EB%AC%B4%EC%97%87%EC%9D%B8%EA%B0%80%EC%9A%94%3F'}}}}}]]}]   ['Security Monitoring의 IPS V2는 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring의 IPS(V2)는 VPC 플랫폼에서 제공하며 Host 기반의 인바운드/아웃바운드 트래픽  을 모니터링하여 의심스러운 활동을 탐지하고 차단해요.\n\nIPS는 24시간 365일 모니터링하고 공격에 대해 실시간 차단함으로써 안전하게 서비스가 운영될 수   있도록 지원해요.\n\nIPS(V2)에서 제공하는 서비스에 대한 자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2112'}}}}}]]}]   ['Anti-Virus 서비스를 사용 시 주의사항은 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': 'Anti-Virus 서비스를 사용 시 주의사항에 대해 알려드릴게요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '내용 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2110?searchKeyword=Anti-Virus%20%EC%84%9C%EB%B9%84%EC%8A%A4%EB%A5%BC%20%EC%82%AC%EC%9A%A9%20%EC%8B%9C%20%EC%A3%BC%EC%9D%98%20%EC%82%AC%ED%95%AD%EC%9D%80%20%EB%AC%B4%EC%97%87%EC%9D%B8%EA%B0%80%EC%9A%94%3F'}}}}}]]}]   ['Anti-Virus 보안 이벤트 발생 시 어떻게 인지할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring Anti-Virus 이벤트 발생 시 Managed 고객에게는 Notification Setting에 설정된   정보로 이벤트 정보를 안내하고 있어요. 상세 정보는 Console에서 확인해 주세요.\n\n※ Security Monitoring에는 Basic과 Managed 서비스가 있으며,\nBasic    서비스를 사용하시는 경우 보안 이벤트가 발생했을 때 정보를 받아볼 이메일을 별도로 설정할 수 없으며, 로그인 ID로 정보를 보내드려요.\nManaged 서비스를   사용하시는 경우 Notification Setting 메뉴에서 정보를 받아볼 이메일을 설정할 수 있으며, 별도 설정을 하지 않으신 경우에는 로그인 ID로 정보를 보내드려   요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히   보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2109'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'Security Monitoring 자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/product/security/securityMonitoring'}}}}}]]}]   ['WAF 모니터링 대상은 어떻게 되나요?'    {'cover': {'type': 'text', 'data': {'description': '\u200bWAF는 HTTP/HTTPS 표준 프로토콜을 사용하는 웹 서비스에 대해서만 모니터링할 수 있어요.\nLoad Balancer 설정된 서비스 모니터링을 위해서 Load Balancer Protocol 을 반드시 HTTP/HTTPS로 설정하셔야 해요. (TCP, SSL로 설정 시 WAF 서비스를 제공받을   수 없습니다.)'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2108?searchKeyword=WAF%20%EB%AA%A8%EB%8B%88%ED%84%B0%EB%A7%81%20%EB%8C%80%EC%83%81%EC%9D%80%20%EC%96%B4%EB%96%BB%EA%B2%8C%20%EB%90%98%EB%82%98%EC%9A%94%3F'}}}}}]]}]   ['OS 커널을 업데이트 할 경우 Security Monitoring에 영향이 있나요?'    {'cover': {'type': 'text', 'data': {'description': '고객이 임의로 OS 커널을 업데이트할 경우, Security Monitoring 서비스가 정상적으로 제공되지 않을   수 있어요.\n커널 업데이트가 필요한 경우 호환 커널 리스트를 참고해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '호환 커널 리스트 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'http://files.trendmicro.com/documentation/guides/deep_security/Kernel%20Support/11.0/Deep_Security_11_kernels_EN.html'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2099'}}}}}]]}]           ['Security Monitoring의 IPS가 뭐야?'    {'cover': {'type': 'text', 'data': {'description': 'IPS(Intrusion Prevention System)란 고객의 서비스로 인입되는 공격을 탐지/차단하는 보안 솔루션으  로, 24시간*365일 모니터링하여 고객의 서비스가 안전하게 운영될 수 있도록 지원하고 있어요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data':   {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2112'}}}}}]]}]   ['Security Monitoring의 보고서는 언제 발송돼?'    {'cover': {'type': 'text', 'data': {'description': '침입행위가 탐지될 경우 이를 분석하여 고객의 서비스에 위협이 된다고 판단되면 보고서를 발송해요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '관련 FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/prod?categoryCode2=SEC&categoryCode3=SV_0043'}}}}}]]}]   ['Security Monitoring에서 탐지된 공격정보는 어디서 확인해?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring에서 탐지된 공격정보는 [콘솔 > Security Monitoring > Dashboard] 에서 확인할   수 있어요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '관련 FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/prod?categoryCode2=SEC&categoryCode3=SV_0043'}}}}}]]}]   ['Security Monitoring에서 침해사고 기술 지원이 뭐야?'    {'cover': {'type': 'text', 'data': {'description': '침해사고 기술 지원은 고객 서비스에 침해사고가 발생하면 대응 전문가가 침해사고에 대한 분석을 수  행하고, 원인을 파악해 차후 동일한 피해가 발생하지 않도록 지원하는 서비스예요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '관련 FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/prod?categoryCode2=SEC&categoryCode3=SV_0043'}}}}}]]}]   ['Security Monitoring에서 Anti-Virus 패턴 업데이트 주기 알려줘'    {'cover': {'type': 'text', 'data': {'description': '백신 패턴은 매일 새벽 1시에 업데이트 되며, 실시간 모니터링에 즉시 반영돼요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '관련 FAQ 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/prod?categoryCode2=SEC&categoryCode3=SV_0043'}}}}}]]}]   ['Security Monitoring의 Anti-Virus가 뭐야?'    {'cover': {'type': 'text', 'data': {'description': 'Anti-Virus는 고객이 운영 중인 서버에 악성코드를 실시간으로 탐지하고 격리/삭제 조치함으로써 고   객의 서비스가 안정적으로 운영될 수 있도록 지원해요.\n플랫폼 환경에 따라 Anti-Virus(V1), Anti-Virus(V2)로 구분되며, Classic 환경에서 제공하는 서비스   는 Anti-Virus(V1), VPC 환경에서 제공하는 서비스는 Anti-Virus(V2)라고 해요.\n\n더 자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2092'}}}}}]]}]   ['Security Monitoring의 WAF가 뭐야?'    {'cover': {'type': 'text', 'data': {'description': 'WAF(Web Application Firewall)는 Web 기반(HTTP/HTTPS) 트래픽을 모니터링하여 공격 트래픽을 탐지   및 차단하는 보안 솔루션이에요.\n\nWAF에서 제공하는 서비스에 대한 자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1,   'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2091'}}}}}]]}]   ['Security Monitoring의 DDoS가 뭐야?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring의 DDoS(Distributed Denial of Service)은 고객의 서비스가 불가능하도록 자원   을 고갈시키는 공격을 의미하며, Anti-DDoS는 고객의 서비스로 인입되는 DDoS 공격을 탐지/차단하여 고객의 서비스가 안정적으로 운영될 수 있도록 지원해요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기  ', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2090'}}}}}]]}]   ['Security Monitoring의 IDS가 뭐야?'    {'cover': {'type': 'text', 'data': {'description': 'IDS는 외부에 공개되어 있는 고객 서비스를 대상으로 시도되는 악의적인 공격을 탐지하는 보안 솔루   션이에요.\n\nIDS는 플랫폼 환경에 따라 IDS(V1), IDS(V2)로 구분되며, Classic 환경에서 제공하는 서비스는 IDS(V1), VPC 환경에서 제공하는 서비스는 IDS(V2)라고 해요.\nIDS 서비스는 24시간 365일 모니터링 함으로써 안전하게 서비스가 운영될 수 있도록 지원해요.\n\nIDS에서 제공하는 서비스에 대한 더 자세한 내  용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2089'}}}}}], [{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': 'Security Monitoring 소개 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/product/security/securityMonitoring'}}}}}]]}]   ['예외요청은 어떻게 할 수 있나요?'    {'cover': {'type': 'text', 'data': {'description': '다음과 같이 Security Monitoring의 예외 요청을 할 수 있어요.\n\n- 탐지된 보안 이벤트가 정상 통   신/ 내부 개발자IP 등의 경우 탐지된 공격자 IP에 대한 예외 요청을 할 수 있어요.\n\n- [네이버 클라우드 플랫폼 > 콘솔 > Services > Security Monitoring > Dashboard]에서 각 서비스별 탐지된 이벤트의 “예외 요청”으로 운영 담당자에게 요청할 수 있어요.\n\n- [고객지원 > 문의하기]를 통해서 "예외 요청" 할 수   있어요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자   세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2118'}}}}}]]}]   ['Security Monitoring을 해지하고 싶습니다. 어떻게 해야 하나요?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring을 해지하고 싶으신 경우,\n[네이버 클라우드 플랫폼 > 콘솔 > Services > Security Monitoring > 상품 더 알아보기 > 이용 문의하기]를 통해 서비스 해지 요청을 할 수 있으며, 네이버 클라우드 플랫폼 담당자가 해지 요청 정보를 검토하여   별도 연락을 드려요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button',   'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2591'}}}}}]]}]    ['WAF(V2) 신청 시 주의사항은 무엇인가요?'    {'cover': {'type': 'text', 'data': {'description': '- WAF(V2)는 Reverse Proxy 방식으로 고객별 별도의 WAF 플랫폼을 구성하여 제공해요.\n- WAF(V2)는   HTTP/HTTPS 트래픽에 대한 보안 모니터링을 제공해요. 그러므로 Application Load Balancer를 사용하는 고객 서비스에만 신청할 수 있어요.\n- HTTPS 서비스    모니터링을 위해서는 WAF에 인증서를 설치해야 하며, 서비스 신청 시 고객 서비스의 인증서도 함께 전달해야 해요.\n- WAF(V2) 서비스를 제공받기 위해서는 고  객 서비스 도메인의 CNAME을 WAF LB로 수정하여 트래픽이 WAF를 향하도록 설정해야 해요. 그러므로 서비스 도메인이 있어야 서비스를 신청할 수 있어요. \n\n   자세한 내용은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기',   'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2589'}}}}}]]}]   ['Security Monitoring을 이용하고 싶습니다. 어떻게 서비스를 신청해야 하나요?'    {'cover': {'type': 'text', 'data': {'description': "1. [ 콘솔 > Security Monitoring > Subscription > 상품 이용 신청 ]에서 약관에 동의해 주세요.\n\n2. [ 고객지원 > 자료 ]에서 'Security Monitoring 서비스 신청서'를 다운로드하여 작성해 주세요.\n\n3. [ 고객지원 > 문의하기 ]를 통해 작성하신 신청서를   함께 접수하시면 담당자가 확인 후 안내드려요.\n\n자세한 내용은 아래 버튼을 눌러 확인해 주세요."}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2588'}}}}}]]}]   ['WAF(V2)에서 CNAME 등록은 왜 필요한가요?'    {'cover': {'type': 'text', 'data': {'description': 'WAF 서비스를 사용하려면 사용자 서비스 도메인의 CNAME을 WAF Load Balancer 도메인 정보로 수정하   여 트래픽이 WAF를 향하도록 설정해야 해요. 서비스 도메인에 대해 CNAME으로 설정하시지 않을 경우, WAF에서 정상 모니터링이 불가해요. \n\n더 자세한 내용   은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2772'}}}}}]]}]   ['WAF 인증서 갱신은 어떻게 하나요?'    {'cover': {'type': 'text', 'data': {'description': '[고객지원 > 문의하기]에 인증서 파일을 첨부하여 WAF 인증서 갱신 요청을 접수하시면 돼요.\n인증서   교체는 약 4영업일 소요되므로, 인증서 만료 전 미리 갱신을 요청해 주세요. \n\n인증서 파일과 관련하여 더 자세한 사항은 아래 버튼을 눌러 확인해 주세요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type':   'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2773'}}}}}]]}]   ['IDS V2 이용 요금은 어떻게 계산되나요?'    {'cover': {'type': 'text', 'data': {'description': 'IDS(V2) 이용 요금은 인터넷 통신 개수 기준으로 계산되며, 서비스 신청일부터 외부에 공개되어 있는   고객 서비스(Public IP, Load Balancer(Public) 등)의 사용 개수를 일일 자동 수집하여 계산돼요.(수집 시간 : 매일 23:30)'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/support/faq/all/2104?searchKeyword=IDS%28V2%29%20%EC%9D%B4%EC%9A%A9%20%EC%9A%94%EA%B8%88%EC%9D%80%20%EC%96%B4%EB%96%BB%EA%B2%8C%20%EA%B3%84%EC%82%B0%EB%90%98%EB%82%98%EC%9A%94%3F'}}}}}]]}]   ['서버를 정지할 경우 관련된 Security Monitoring 이용 요금 정책은 어떻게 되나요?'    {'description': 'Security Monitoring 이용 요금은 서버 정지와 무관하게 청구되니 과금을 원하지 않으시면, 서버 정지시 Security Monitoring 계약도 함께   해지해 주세요.'}]   ['Security Monitoring 이용요금 얼마야?'    {'cover': {'type': 'text', 'data': {'description': 'Security Monitoring 이용요금에 대해 아래 버튼을 눌러 확인하실 수 있어요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/product/security/securityMonitoring'}}}}}]]}]   ['IPS/WAF에서 1개월 탐지 모드가 꼭 필요한가요?'    {'description': 'IPS/WAF에서 1개월 탐지 모드는 안정적인 서비스 운영을 위해서 필요해요.\n서비스 개시 즉시 차단 모드로 운영할 경우에는 오탐에 의해    정상 트래픽도 차단될 수 있어요.'}]   ['IPS V2 서비스는 어떻게 운영되나요?'    {'description': 'IPS(V2) 서비스는 IPS Agent 설치 -> Recommendation Scan 실행 후 약 1개월 탐지 모드로 운영(3주 탐지 모드 운영, 1주 이벤트 분석) ->   고객에게 분석 내용 검토 요청 -> IPS 차단 모드 변경 및 정책 적용으로 진행돼요.\n콘솔에서는 IPS 차단 모드 변경 후 차단되는 로그만 제공해요. (탐지 모드  로 운영 중에는 콘솔에서 확인되는 로그는 없습니다.)\n약 1개월 탐지 모드로 운영 완료 후 탐지 이벤트 분석 후 차단 정책 및 차단 모드 변경 일정을 고객에   게 제안해요.'}]   ['IPS V2의 Recommendation Scan 기능은 무엇인가요?'    {'description': 'IPS(V2)의 Recommendation Scan은 VM에 설치된 OS, Application 정보를 검사하여 각 시스템 별로 적합한 탐지 정책을 자동으로 적용해주는   기능이에요.'}]   ['IPS V2의 가상 패치 기능은 무엇인가요?'    {'description': 'IPS(V2)의 가상 패치는 OS 및 Application의 취약점을 수정하는 보안 패치를 설치하는 대신 취약점을 악용하는 공격을 네트워크 레벨에서   일시적으로 차단하는 기능이에요. 가상 패치는 일시적인 보호를 목적으로 하기에 근본적인 해결을 위해서는 보안 패치를 해야 해요.'}]   ['IPS V1 서비스는 어떻게 운영되나요?'    {'description': 'IPS(V1)은 서비스 신청 후 약 1개월 탐지 모드로 운영(이벤트 탐지 및 분석) -> 고객에게 분석 내용 검토 요청 -> IPS 차단모드 변경 및    차단 정책 적용으로 진행돼요.\n콘솔에서는 IPS 차단 모드 변경 후 차단되는 로그만 제공해요. (탐지 모드로 운영 중에는 콘솔에서 확인되는 로그는 없습니다.)\n약 1개월 탐지 모드로 운영 완료 후 탐지 이벤트 분석 후 차단 정책 및 차단 모드 변경 일정을 고객에게 제안해요.'}]   ['WAF 서비스는 어떻게 운영되나요?'    {'description': 'WAF 서비스 신청 후 약 1개월 탐지 모드로 운영(이벤트 탐지 및 분석) -> 고객에게 분석 내용 검토 요청 -> WAF 차단모드 변경 및 차단 정  책 적용으로 진행돼요.\n콘솔에서는 WAF 차단 모드 변경 후 차단되는 로그만 제공. (탐지 모드로 운영 중에는 콘솔에서 확인되는 로그는 없습니다.)\n약 1개월   탐지 모드로 운영 완료 후 탐지 이벤트 분석 후 차단 정책 및 차단 모드 변경 일정을 고객에게 제안합니다.'}]   ['Anti-DDoS 모니터링 대상은 어떻게 되나요?'    {'description': 'Anti-DDoS는 신청한 Region 및 Platform에서 Public IP 및 Load Balancer IP(Public)로 제공되는 서비스를 모니터링해요.\n신청하신 모니   터링 대상이 변경될 경우, 반드시 서비스 신청서로 변경 사항을 재요청해 주셔야 해요. 요청 없이 모니터링 대상을 변경할 경우 Anti-DDoS 모니터링 대상에 반  영되지 않을 수 있어요.'}]   ['IDS V2 모니터링 대상 및 외부에 공개되어 있는 고객 서비스의 기준은 무엇인가요?'    {'description': 'IDS(V2)의 모니터링 대상 및 외부에 공개되어 있는 고객 서비스의 기준은 침입 탐지의 누락을 방지하기 위해서 신청한 Region 및 Platform에서 외부에 공개되어 있는 Public IP, Load Balancer(Public) 서비스를 의미해요.'}]   ['IDS에 설정된 탐지 정책을 제공해 줄 수 있나요?'    {'description': 'IDS 탐지 정책은 네이버 클라우드 플랫폼의 오랜 보안 관제 경험이 축적된 자산으로 고객에게 별도로 제공하고 있지는 않아요.'}]           ['Security Monitoring Web Security Checker 연동 돼?'    {'description': 'Web Security Checker 연동으로 고객의 웹 서비스에 대한 주요 취약점을 자동으로 진단할 수 있어요.'}]   ['Security Monitoring Public IP 연동 돼?'    {'description': 'Security Monitoring 서비스 중 IDS, IPS, WAF, Anti-DDoS는 Public IP와의 연동으로 고객 서비스로 인입되는 보안 위협을 실시간으로 감   시, 탐지 차단하여 안전하게 보호하고 있어요.'}]   ['Security Monitoring Load Balancer 연동 돼?'    {'description': 'Security Monitoring 서비스 중 IDS, IPS, WAF, Anti-DDoS는 Load Balancer와의 연동으로 고객 서비스로 인입되는 보안 위협을 실시간으로   감시, 탐지 차단하여 안전하게 보호하고 있어요.'}]   ['Security Monitoring Server 연동 돼?'    {'description': '네이버 클라우드 플랫폼의 서버에서 발생하는 트래픽에 한해 Security Monitoring 서비스를 제공하고 있어요.'}]   ['Security Monitoring 어떤 부가 서비스와 연동이 돼?'    {'description': 'Security Monitoring 연동 부가 서비스들이에요.\n● Server\n● Load Balancer\n● Public IP\n● DNS\n● Web Security Checker'}]   ['Security Monitoring의 자세한 기능을 알려줘'    {'cover': {'type': 'text', 'data': {'description': '고객님의 안전한 보안 서비스를 위하여 IDS, Anti-DDoS, WAF, Anti-Virus, IPS, 침해사고 기술지원    서비스를 제공하고 있어요.'}}, 'contentTable': [[{'rowSpan': 1, 'colSpan': 1, 'data': {'type': 'button', 'title': '자세히 보기', 'data': {'type': 'basic', 'action': {'type': 'link', 'data': {'url': 'https://www.ncloud.com/product/security/securityMonitoring'}}}}}]]}]   ['Security Monitoring 특징이 뭐야'    {'description': 'Security Monitoring은 외부의 보안 위협을 실시간으로 감시하고, 탐지된 이벤트에 효율적으로 대응할 수 있는 자동화된 보안 시스템이에   요.'}]]"
}
           ]
