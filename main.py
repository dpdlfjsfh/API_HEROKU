...
rag_data = [{
        "category": "스킬셋 튜닝",
        "context": "스킬셋 튜닝은 서비스에 특화된 지식을 모델에게 학습시키는 것을 의미합니다. 모델이 더 정확하고 정교한 답변을 생성할 수 있도록 스킬셋을 학습시키고 학습한 내역을 관리하는 방법을 설명합니다.
        스킬셋 학습 스킬셋을 학습시키는 방법은 다음과 같습니다.
        ...
        [작업] 탭을 클릭해 주십시오.
        [학습 시작] 버튼을 클릭해 주십시오.
        새 학습 창이 나타나면 학습할 스킬셋을 선택해 주십시오.
        학습 명이나 학습 관련된 내용을 메모에 입력해주십시오.(필수)
        학습 시 사용될 토큰 수를 확인한 후 [학습] 버튼을 클릭해 주십시오.
        학습 대기 중 창이 나타나면 [확인] 버튼을 클릭해 주십시오.
        학습 진행 알림과 완료 알림이 사용자의 메일로 발송됩니다.
        [중단] 버튼을 클릭하면 학습을 중단할 수 있습니다.
        참고
        스킬셋을 학습시키려면 '작업 완료' 상태인 스킬과 시나리오가 최소한 1개씩 존재해야 합니다. 만약 선택 가능한 스킬셋이 없는 경우에는 스킬의 작업 상태를 확인해 주십시오.        
        스킬셋 학습 목록 확인
        스킬셋을 학습시킨 이력을 확인하는 방법은 다음과 같습니다.      
        네이버 클라우드 플랫폼 콘솔에서 Services > AI Services > CLOVA Studio 메뉴를 차례대로 클릭해 주십시오.
        My Product 메뉴를 클릭한 후 [CLOVA Studio 바로가기] 버튼을 클릭해 주십시오.
        CLOVA Studio에서 우측 상단에 있는 사용자 이름을 클릭한 후 내 작업 메뉴를 클릭해 주십시오.
        [스킬 트레이너] 탭을 클릭해 주십시오.
        clovastuido-skillset-tuning_view_ko
        영역	설명
        ① 정렬 및 검색	
        정렬 방식 선택. 최신순, 오래된순, 이름순 정렬 가능
        학습 검색 가능
        ② 학습 목록	학습한 스킬셋의 목록
        ③ [학습 시작] 버튼	새로운 학습 목록을 생성하는 화면으로 이동
        학습 목록이 나타나면 작업 상태를 확인해 주십시오.
        학습 완료: 학습이 정상적으로 완료된 상태
        학습 중: 학습이 진행 중인 상태
        학습 대기 중: 학습을 준비 중인 상태
        학습 실패: 학습에 실패한 상태
        학습 중단: 사용자가 직접 학습을 중단한 상태
        학습 중단
        스킬셋의 학습 상태가 학습 대기 중, 학습 중인 경우에는 학습을 중단시킬 수 있습니다.
        스킬셋 학습을 중단하는 방법은 다음과 같습니다.
        네이버 클라우드 플랫폼 콘솔에서 Services > AI Services > CLOVA Studio 메뉴를 차례대로 클릭해 주십시오.
        My Product 메뉴를 클릭한 후 [CLOVA Studio 바로가기] 버튼을 클릭해 주십시오.
        CLOVA Studio에서 우측 상단에 있는 사용자 이름을 클릭한 후 내 작업 메뉴를 클릭해 주십시오.
        [스킬 트레이너] 탭을 클릭해 주십시오.
        중단할 학습을 클릭해 주십시오.
        학습 중단 팝업 창이 나타나면 [중단] 버튼을 클릭해 주십시오."
}]
